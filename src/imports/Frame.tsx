...
function TitleArea() {
  return (
    <div className="absolute bottom-[408px] content-stretch flex flex-col gap-[46px] items-start justify-end left-[252px] not-italic text-black w-[1416px]" data-name="Title area">
      <p className="css-4hzbpn font-['Inter:Medium',sans-serif] font-medium leading-[36px] relative shrink-0 text-[26px] tracking-[1px] uppercase w-[728px]">Oct 1, 2024</p>
      <p className="css-4hzbpn font-['Inter:Bold',sans-serif] font-bold leading-[144px] min-w-full relative shrink-0 text-[140px] tracking-[-2px] w-[min-content]" style={{ fontFeatureSettings: "'salt', 'ss03', 'ss04', 'cv01', 'cv02', 'lnum', 'pnum'" }}>
        Template
      </p>
    </div>
  );
  ...
  return (
    <div className="bg-white relative size-full" data-name="Frame">
      ...
      <div className="absolute bottom-[264px] flex flex-col font-['Inter:Medium',sans-serif] font-medium justify-end leading-[0] left-[252px] not-italic text-[40px] text-black tracking-[-0.6px] w-[976px]">
        <p className="css-4hzbpn leading-[48px]">Aaron Tate</p>
      </div>
