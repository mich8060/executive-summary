import svgPaths from "./svg-ccn89a3cp0";
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full" data-name="Frame">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[72px] left-[calc(50%-0.5px)] not-italic text-[64px] text-black text-center top-[calc(50%-96px)] tracking-[-1.2px] w-[1487px]">We can rebuild the front end, validate with users, and deliver React-ready experiences for engineering to integrate.</p>
      <ChgLogoHK />
      <ThemeBar />
    </div>
  );
