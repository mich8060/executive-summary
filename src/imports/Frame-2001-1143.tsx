import svgPaths from "./svg-q0a1ulcrjh";
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full" data-name="Frame">
      <p className="-translate-x-1/2 absolute font-['Inter:Bold',sans-serif] font-bold leading-[144px] left-[calc(50%+0.5px)] not-italic text-[140px] text-black text-center top-[calc(50%-99px)] tracking-[-2px] w-[1799px]" style={{ fontFeatureSettings: "'salt', 'ss03', 'ss04', 'cv01', 'cv02', 'lnum', 'pnum'" }}>
        What does this mean...
      </p>
      <ChgLogoHK />
      <ThemeBar />
