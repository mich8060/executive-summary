import svgPaths from "./svg-66zrdrdjnk";
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full" data-name="Frame">
      <p className="-translate-x-1/2 absolute font-['Inter:Medium',sans-serif] font-medium leading-[72px] left-[calc(50%+0.5px)] not-italic text-[64px] text-black text-center top-[calc(50%-23px)] tracking-[-1.2px] w-[1799px]">Proof of value from Engineering</p>
      <ChgLogoHK />
      <ThemeBar />
    </div>
  );
