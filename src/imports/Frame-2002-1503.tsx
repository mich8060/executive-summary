import svgPaths from "./svg-q4wph0g0y2";
...
export default function Frame() {
  return (
    <div className="bg-white relative size-full" data-name="Frame">
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold leading-[72px] left-[109px] not-italic text-[64px] text-black top-[65px] tracking-[-1.2px] w-[1264px]">Experiment</p>
      <ChgLogoHK />
      <ThemeBar />
    </div>
  );
